...
namespace MentorBook.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ILocationRepository>(x => new LocationRepository(sqlConnectionString));
            services.AddScoped<ILocationService, LocationService>();

            services.AddScoped<IFriendshipRepository>(x => new FriendshipRepository(sqlConnectionString));
            services.AddScoped<IFriendshipService, FriendshipService>();

            services.AddScoped<IPostsRepository>(x => new PostsRepository(sqlConnectionString));
            services.AddScoped<IPostsService, PostsService>();

            services.AddControllers();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MentorBook.Web", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MentorBook.Web v1"));
            }
